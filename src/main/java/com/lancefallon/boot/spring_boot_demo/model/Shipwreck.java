package com.lancefallon.boot.spring_boot_demo.model;
...
public class Shipwreck {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="shipwreck_id_seq")
    @SequenceGenerator(name="shipwreck_id_seq", sequenceName="shipwreck_id_seq", allocationSize=1)
	Long id;
	String name;
	String description;
	String condition;
